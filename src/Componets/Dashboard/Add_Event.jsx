...
const Add_Event = () => {
    ...
    const btnhandle = (e) => {
        e.preventDefault()
        axios.post('http://localhost:2000/event', {
            eventname: eventname,
            date: date,
            address: address,
            month: month,
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-md-7 col-sm-12">
                            ...
                            <ul className="breadcrumb float-md-right">
                                ...
                                <li className="breadcrumb-item"><a href="javascript:void(0);">Event</a></li>
                                        ...
                                        <div className="row clearfix">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <input type="text" className="form-control" name='eventname' value={eventname} onChange={(e) => { seteventname(e.target.value) }} placeholder="Event Name" />
                                                </div>
                                            </div>
